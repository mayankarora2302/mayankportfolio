// Mock data for Mayank Arora's Portfolio
  ...
  events: [
    {
      ...
      description: "17,000+ participants registered \u00b7 InfinyOn Technology Track",
      year: "2025"
    },
    {
      icon: "Trophy",
      title: "3rd Place \u2014 LogicX DLCD Hardware Competition",
      description: "Custom retro gaming console \u00b7 Raspberry Pi Pico",
      year: "2025"
    },
    {
      icon: "CheckCircle",
      title: "Selected \u2014 Smart India Hackathon (SIH) 2025",
      description: "Project contributor selection",
      year: "2025"
    },
    {
      icon: "Shield",
      title: "106 Rooms \u2014 TryHackMe",
      description: "Jr. Penetration Tester Path Completed",
      year: "2024\u20132025"
    },
    {
      icon: "GraduationCap",
      title: "B.Tech Information Technology \u2014 BPIT, GGSIPU",
      description: "2024 \u2013 2028 \u00b7 New Delhi",
      year: "2024"
    }
  ]
};
